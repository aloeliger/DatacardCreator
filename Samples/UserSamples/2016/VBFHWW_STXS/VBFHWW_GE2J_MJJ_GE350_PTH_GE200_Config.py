...
from Samples.Uncertainties.UserUncertainties.QCDAcceptanceUncertainties.qqH_QCD_AcceptanceUncertainties.qqH_scale_highmjj_highpt_Uncertainty import qqH_scale_highmjj_highpt_Uncertainty

from Samples.EventDefinition.UserEventDictionaries.MuTauEventDictionary import MuTauEventDictionary

VBFSample = Sample()
VBFSample.name = 'qqH_GE2J_MJJ_GE350_PTH_GE200_hww125'
VBFSample.path = '/data/aloeliger/SMHTT_Selected_2016_Deep/'
VBFSample.files = ['VBFHWW.root']
VBFSample.definition = 'Rivet_stage1_1_cat_pTjet30GeV == 206'
...
#    qqH_scale_highmjj_highpt_Uncertainty(),
]
