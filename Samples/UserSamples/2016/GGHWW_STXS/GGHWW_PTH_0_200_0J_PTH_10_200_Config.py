...
from Samples.Uncertainties.UserUncertainties.QCDAcceptanceUncertainties.ggH_QCD_AcceptanceUncertainties.ggH_scale_0jet_Uncertainty import ggH_scale_ggH_0jet_Uncertainty

from Samples.EventDefinition.UserEventDictionaries.MuTauEventDictionary import MuTauEventDictionary

ggHSample = Sample()
ggHSample.name = 'ggH_PTH_0_200_0J_PTH_10_200_hww125'
ggHSample.path = '/data/aloeliger/SMHTT_Selected_2016_Deep/'
ggHSample.files = ['GGHWW.root']
ggHSample.definition = 'Rivet_stage1_1_cat_pTjet30GeV == 103'
...
#    ggH_scale_ggH_0jet_Uncertainty(),
]
