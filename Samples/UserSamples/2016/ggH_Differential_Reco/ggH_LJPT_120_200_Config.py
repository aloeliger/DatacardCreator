...
ggHSample = Sample()
ggHSample.name = 'ggH_recoJ1PT_120_200'
ggHSample.path = '/data/aloeliger/SMHTT_Selected_2016_Deep/'
ggHSample.files = ['ggH.root']
#ggHSample.definition = 'is_Fiducial == 1.0 && Rivet_nJets30 >= 1 && Rivet_j1pt >= 120 && Rivet_j1pt <= 200'
ggHSample.definition = 'is_Fiducial == 1.0 && jpt_1 >= 120 && jpt_1 <= 200'
