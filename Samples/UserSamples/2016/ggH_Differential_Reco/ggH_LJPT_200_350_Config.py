...
ggHSample = Sample()
ggHSample.name = 'ggH_recoJ1PT_200_350'
ggHSample.path = '/data/aloeliger/SMHTT_Selected_2016_Deep/'
ggHSample.files = ['ggH.root']
#ggHSample.definition = 'is_Fiducial == 1.0 && Rivet_nJets30 >= 1 && Rivet_j1pt >= 200 && Rivet_j1pt <= 350'
ggHSample.definition = 'is_Fiducial == 1.0 && jpt_1 >= 200 && jpt_1 <= 350'
