...
from Samples.Uncertainties.UserUncertainties.QCDAcceptanceUncertainties.VH_QCD_AcceptanceUncertainties.WH_scale_Inclusive_Uncertainty import WH_scale_Inclusive_Uncertainty
...
WHSample.uncertainties = [
    ...
    WH_scale_Inclusive_Uncertainty(),    
]
