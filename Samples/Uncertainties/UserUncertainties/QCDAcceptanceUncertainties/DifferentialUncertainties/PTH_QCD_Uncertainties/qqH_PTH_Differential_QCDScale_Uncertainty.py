...
class qqH_PTH_Differential_QCDScale_Uncertainty(Uncertainty):
    ...
    def CreateQCDScaleqqHDictionaryUp(self,theTree,nominalEventDictionary):
        ...
        if theTree.Rivet_higgsPt > 0 and theTree.Rivet_higgsPt <= 45:
            ...
            modifiedEventDictionary.Weight = theTree.FinalWeighting_QCDScaleAcceptance_Differential_qqH_pth_gt450UP
    ...
    def CreateQCDScaleqqHDictionaryDown(self,theTree,nominalEventDictionary):
        ...
        if theTree.Rivet_higgsPt > 0 and theTree.Rivet_higgsPt <= 45:
            ...
            modifiedEventDictionary.Weight = theTree.FinalWeighting_QCDScaleAcceptance_Differential_qqH_pth_gt450DOWN
        if modifiedEventDictionary.Weight == 0:
            return nominalEventDictionary
        return modifiedEventDictionary
