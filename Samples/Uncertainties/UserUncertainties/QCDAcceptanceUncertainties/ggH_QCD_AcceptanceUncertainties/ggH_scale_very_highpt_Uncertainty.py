...
class ggH_scale_very_highpt_Uncertainty(Uncertainty):
    def __init__(self):
    ...
    def CreateScaleVeryHighPtDictionaryUp(self,theTree,nominalEventDictionary):
        ...
        modifiedEventDictionary.Weight = theTree.FinalWeighting_QCDScaleAcceptance_ggH_scale_very_highpt_UP
        return modifiedEventDictionary
    def CreateScaleVeryHighPtDictionaryDown(self,theTree,nominalEventDictionary):
        modifiedEventDictionary = nominalEventDictionary.Clone()
        modifiedEventDictionary.Weight = theTree.FinalWeighting_QCDScaleAcceptance_ggH_scale_very_highpt_DOWN
        return modifiedEventDictionary
