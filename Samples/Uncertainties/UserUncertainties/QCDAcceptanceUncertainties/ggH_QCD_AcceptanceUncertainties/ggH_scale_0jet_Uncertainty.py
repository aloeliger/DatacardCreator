...
class ggH_scale_ggH_0jet_Uncertainty(Uncertainty):
    def __init__(self):
    ...
    def CreateScale0JetDictionaryUp(self,theTree,nominalEventDictionary):
        ...
        modifiedEventDictionary.Weight = theTree.FinalWeighting_QCDScaleAcceptance_ggH_scale_0jet_UP
        return modifiedEventDictionary
    def CreateScale0JetDictionaryDown(self,theTree,nominalEventDictionary):
        modifiedEventDictionary = nominalEventDictionary.Clone()
        modifiedEventDictionary.Weight = theTree.FinalWeighting_QCDScaleAcceptance_ggH_scale_0jet_DOWN
        return modifiedEventDictionary
