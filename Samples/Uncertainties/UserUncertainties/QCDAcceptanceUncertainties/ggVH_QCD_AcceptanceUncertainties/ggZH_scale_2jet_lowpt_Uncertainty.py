...
class ggZH_scale_2jet_lowpt_Uncertainty(Uncertainty):
    def __init__(self):
    ...
    def CreateScale2JetLowPtDictionaryUp(self,theTree,nominalEventDictionary):
        ...
        modifiedEventDictionary.Weight = theTree.FinalWeighting_QCDScaleAcceptance_ggVH_scale_2jet_lowpt_UP
        return modifiedEventDictionary
    def CreateScale2JetLowPtDictionaryDown(self,theTree,nominalEventDictionary):
        modifiedEventDictionary = nominalEventDictionary.Clone()
        modifiedEventDictionary.Weight = theTree.FinalWeighting_QCDScaleAcceptance_ggVH_scale_2jet_lowpt_DOWN
        return modifiedEventDictionary
