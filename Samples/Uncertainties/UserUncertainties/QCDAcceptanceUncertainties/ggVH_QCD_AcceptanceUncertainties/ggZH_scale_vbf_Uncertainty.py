...
class ggZH_scale_vbf_Uncertainty(Uncertainty):
    def __init__(self):
    ...
    def CreateScaleVbfDictionaryUp(self,theTree,nominalEventDictionary):
        ...
        modifiedEventDictionary.Weight = theTree.FinalWeighting_QCDScaleAcceptance_ggVH_scale_vbf_UP
        return modifiedEventDictionary

    def CreateScaleVbfDictionaryDown(self,theTree,nominalEventDictionary):
        modifiedEventDictionary = nominalEventDictionary.Clone()
        modifiedEventDictionary.Weight = theTree.FinalWeighting_QCDScaleAcceptance_ggVH_scale_vbf_DOWN
        return modifiedEventDictionary
