...
class ggZH_scale_highpt_Uncertainty(Uncertainty):
    def __init__(self):
    ...
    def CreateScaleHighPtDictionaryUp(self,theTree,nominalEventDictionary):
        ...
        modifiedEventDictionary.Weight = theTree.FinalWeighting_QCDScaleAcceptance_ggVH_scale_highpt_UP
        return modifiedEventDictionary
    def CreateScaleHighPtDictionaryDown(self,theTree,nominalEventDictionary):
        modifiedEventDictionary = nominalEventDictionary.Clone()
        modifiedEventDictionary.Weight = theTree.FinalWeighting_QCDScaleAcceptance_ggVH_scale_highpt_DOWN
        return modifiedEventDictionary
