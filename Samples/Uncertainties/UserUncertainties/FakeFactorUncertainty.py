...
class FakeFactorUncertainty(Uncertainty):
    def __init__(self):
	    ...
	    "CMS_FF_closure_lpt_mt_ttUp",
            ...
            "CMS_FF_closure_pth_0jet_mt_wUp",
	    ...
	    "CMS_FF_closure_lpt_mt_ttDown",
            ...
            "CMS_FF_closure_pth_0jet_mt_wDown",
	    ...
	    "CMS_FF_closure_lpt_mt_ttUp":self.CreateLPTClosureTTUpDictionary,
            ...
            "CMS_FF_closure_pth_0jet_mt_wUp":self.CreatePTHClosure0JetUncUpDictionary,
	    ...
	    "CMS_FF_closure_lpt_mt_ttDown":self.CreateLPTClosureTTDownDictionary,
            ...
            "CMS_FF_closure_pth_0jet_mt_wDown":self.CreatePTHClosure0JetUncDownDictionary,
