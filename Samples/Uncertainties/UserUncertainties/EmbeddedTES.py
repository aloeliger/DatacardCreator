...
class EmbeddedTESUncertainty(Uncertainty):
    def __init__(self):
        ...
        self.uncertaintyNames = [                        
            ...
            "CMS_scale_emb_t_3prong1pizeroUp",
            "CMS_scale_emb_t_3prong1pizeroDown"
            ]
        self.eventDictionaryModifications = {
            ...
            "CMS_scale_emb_t_3prong1pizeroUp":self.CreateThreeProngOnePizeroUpModifiedDictionary,
            "CMS_scale_emb_t_3prong1pizeroDown":self.CreateThreeProngDownModifiedDictionary
            }
