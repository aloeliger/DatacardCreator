...
def IsInBoostedOneJetCategory(theAnalysisCategory,theEventDictionary):
    if(
            ...
            and (theEventDictionary.eventDictionary['M_sv'] <= 90.0 or theEventDictionary.eventDictionary['M_sv'] >= 150.0)
    ):
        return True
    else:
        return False
...
Boosted1J.rollingBins = [0.0,60.0,120.0,200.0,250.0,10000.0]
Boosted1J.reconstructionVariable = 'M_sv'
Boosted1J.reconstructionBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,290.0]
